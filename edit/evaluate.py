...
from util.eval_utils.eval_utils_counterfact import compute_rewrite_quality_counterfact,compute_rewrite_quality_counterfact_IK
...
from pmet_ns import PMET_NSHyperParams, apply_pmet_ns_to_model
...
ALG_DICT = {
    ...
    "PMET_NS": (PMET_NSHyperParams, apply_pmet_ns_to_model),
...
def main(
    ...
    for record_chunks in chunks(ds, num_edits):
        ...
        etc_args = dict(cache_template=cache_template) if any(alg in alg_name for alg in ["MEMIT", "PMET", "ROME", "PMET_NS", "EMMET"]) else dict()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
            "--alg_name",
            choices=["MEMIT", "ROME", "FT", "MEND", "PMET", "PMET_NS", "EMMET"],
            default="PMET",
    ...
    parser.add_argument(
        "--model_name",
        choices=["EleutherAI/gpt-neox-20b", "EleutherAI/gpt-j-6b","Llama-2-7b-hf"],
